...
PICS = (environ.get('PICS', 'https://i.ibb.co/MymFhWq6/IMG-20250510-221627-759.jpg https://i.ibb.co/dsHLFR0D/IMG-20250510-221627-638.jpg https://i.ibb.co/YB27nnpc/IMG-20250510-221627-447.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5398056049 1905251964').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001967161880 -1001783384740').split()]  # Channel id for auto indexing (make sure bot is admin)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002540003784')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002351984164')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002387618380 -1001940661697').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002387618380 -1001940661697').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'ThisBoTisFree')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "LILY")
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+Xk-hrkP2xb85YTc1')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+ix9P65l4kPUwYWM1')  # Support group link (make sure bot is admin)
